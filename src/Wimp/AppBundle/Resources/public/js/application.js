...
(function() {
  ...
  Content = (function(_super) {
    ...
    Content.prototype.events = {
      'change_video': '_changeVideo'
    };

    function Content() {
      this._changeVideo = __bind(this._changeVideo, this);

      this.render = __bind(this.render, this);
      Content.__super__.constructor.apply(this, arguments);
      this.render();
      this.player = new Player;
      this.playerEl.append(this.player.render());
    }
    ...
    Content.prototype._changeVideo = function() {};
  ...
  Sidebar = (function(_super) {
    ...
    Sidebar.prototype.displayItem = function(slug) {
      var item;
      item = Videos.filter(slug);
      return this.videoList.change(item[0]);
    };
    ...
    Sidebar.prototype.refreshScrollbar = function() {
      ...
      return t = setTimeout(function() {
        ...
        return $('.video-list-wraper').tinyscrollbar({
          updateOffset: 120
        });
      }, 0);
    };
    ...
    function App() {
      ...
      this.routes({
        "/view/:slug": function(params) {
          this.sidebar.displayItem(params.slug);
          return this.content.el.trigger('change_video');
        }
      });
    }
