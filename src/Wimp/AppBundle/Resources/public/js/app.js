...
(function() {
  ...
  Customlist = (function(_super) {
    ...
    Customlist.prototype.render = function(items) {
      Customlist.__super__.render.apply(this, arguments);
      this.ch = this.children();
      this.s = 0;
      return this.loadMore();
    };

    Customlist.prototype.loadMore = function() {
      var i, _i, _ref, _ref1;
      for (i = _i = _ref = this.s, _ref1 = this.s + 30; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = _ref <= _ref1 ? ++_i : --_i) {
        $(this.ch[i]).css({
          display: 'block'
        });
      }
  ...
  Player = (function(_super) {
    ...
    function Player() {
      this.flowplayer = __bind(this.flowplayer, this);
    ...
    Player.prototype.flowplayer = function() {
      return this.player.flowplayer({
        swf: '/bundles/wimpapp/player/flowplayer.swf',
        engine: 'html5',
        fullscreen: true,
  ...
  Sidebar = (function(_super) {
    ...
    Sidebar.prototype.setEvents = function() {
      ...
      return this.wraper.bind('maxReached', this.loadMore);
    };

    Sidebar.prototype.renderVideoList = function(items) {
      this.videoList.render(items);
      this.refreshScrollbar();
      Spine.Route.setup({
        history: true
      });
      return this.videoList.triggerScroll = false;
    };
    ...
    Sidebar.prototype.loadMore = function() {
...
;( function( $ ) 
{
    ...
    function Scrollbar( root, options )
    {
        ...
        function scrollToOffset(scroll)
        {
            ...
            if(maxScroll < (iScroll + updateOffset)){
                clearTimeout(t);
  ...
  Video = (function(_super) {
    ...
    Video.configure('Video', 'title', 'subtitle', 'slug');
    ...
    Video.fetch = function(params) {
      var index, _ref;
      index = ((_ref = this.last()) != null ? _ref.id : void 0) || 0;
      if (index === this.index) {
        return false;
      }
      this.index = index;
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(this.videoURL));
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(this.thumbImg));
